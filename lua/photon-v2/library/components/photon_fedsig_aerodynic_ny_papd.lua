...
COMPONENT.PrintName = [[Federal Signal Aerodynic NY&NJ PAPD]]

COMPONENT.Model = "models/sentry/props/aerodynic2.mdl"

COMPONENT.SubMaterials = {
	[2] = "rin/papd/props/aerodynic/glass",
}
...
COMPONENT.Elements = {
	[1] = { "Rotator", BoneId = 3, Axis = "z", Speed = -400 },
	[2] = { "Rotator", BoneId = 2, Axis = "z", Speed = -400 },
	[3] = { "Rotator", BoneId = 1, Axis = "z", Speed = -400 },
	[4] = { "Rotator", BoneId = 5, Axis = "z", Speed = -400 },
	[5] = { "Rotator", BoneId = 6, Axis = "z", Speed = -400 }, -- 5
	[6] = { "Rotator", BoneId = 7, Axis = "z", Speed = -400 }, -- 3
