...
COMPONENT.PrintName = [[Federal Signal Aerodynic FDNY]]

COMPONENT.Model = "models/sentry/props/aerodynic2.mdl"

COMPONENT.SubMaterials = {
	[2] = "rin/fdny/props/aerodynic/glass",
}
...
COMPONENT.Elements = {
	[1] = { "Rotator", BoneId = 3, Axis = "z", Speed = -580 },
	[2] = { "Rotator", BoneId = 2, Axis = "z", Speed = -350 },
	[3] = { "Rotator", BoneId = 1, Axis = "z", Speed = -580 },
	[4] = { "Rotator", BoneId = 5, Axis = "z", Speed = -580 },
	[5] = { "Rotator", BoneId = 6, Axis = "z", Speed = -350 }, -- 5
	[6] = { "Rotator", BoneId = 7, Axis = "z", Speed = -580 }, -- 3
