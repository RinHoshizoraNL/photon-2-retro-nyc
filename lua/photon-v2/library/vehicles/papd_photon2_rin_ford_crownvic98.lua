...
VEHICLE.Title 		= "1998 Ford Crown Victoria PAPD"
		...
		Options = {
			{
				Option = "Patrol",
				SubMaterials = {
					{ Id = 3, Material = "rin/papd/crownvic98/patrol_98" }
				},
			},
			{
				Option = "DWI Enforcement",
				SubMaterials = {
					{ Id = 3, Material = "rin/papd/crownvic98/dwi_98" }
				},
			},
			{
				Option = "K9 Unit",
				SubMaterials = {
					{ Id = 3, Material = "rin/papd/crownvic98/k9_98" }
				},
			},
		}
	},
