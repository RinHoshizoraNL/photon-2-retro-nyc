...
VEHICLE.Title 		= "1995 Ford Crown Victoria FDNY"
		...
		Options = {
			{
				Option = "Blue",
				SubMaterials = {
					{ Id = 6, Material = "rin/fdny/crownvic96/fire_96_blue" }
				},
				Props = {
					{
			...
			},
			{
				Option = "White",
				SubMaterials = {
					{ Id = 6, Material = "rin/fdny/crownvic96/fire_96_white" }
				},
				Props = {
					{
						Model = "models/xenosprops/na_plate/na_plate_gov.mdl",
