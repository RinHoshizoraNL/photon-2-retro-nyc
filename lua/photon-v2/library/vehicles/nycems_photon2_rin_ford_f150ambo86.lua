...
VEHICLE.Title 		= "1986 Ford F150 Ambulance NYC EMS"
...
VEHICLE.Equipment = {
	...
	},
	{
		...
		Options = {
            {
				Option = "Code3 SD Mini",
				Components = {
					{
                        Component = "code3_sd_mini",
                        Position = Vector( 0, -223.5, 117 ),
                        Angles = Angle( 0, 0,  0),
                        Scale = 1.1,
					},
				},
				Props = {
					{
						...
						Position = Vector( 0, -223.1, 113 ),
						Angles = Angle( 90, 270, 0 ),
						Scale = Vector( 2.5, 8, 5.5 ),
						SubMaterials = {
		...
		Options = {
			{
				...
				Props = {
					...
					{
						Model = "models/gandhi/props/es100.mdl",
						Position = Vector( 13, 109.2, 33.15),
						Angles = Angle( 0, 90, 0 ),
						Scale = 1,
						SubMaterials = {
