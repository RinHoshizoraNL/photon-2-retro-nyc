...
VEHICLE.Title 		= "1991 Chevrolet Caprice NYC Sheriff"
		...
		Options = {
			{
				Option = "Patrol 1991",
				SubMaterials = {
					{ Id = 20, Material = "rin/ny_sheriff/caprice91/sheriff_91" },
		...
		Options = {
            {
				...
				Components = {
					{
                        Component = "photon_fedsig_aerodynic_nysheriff",
