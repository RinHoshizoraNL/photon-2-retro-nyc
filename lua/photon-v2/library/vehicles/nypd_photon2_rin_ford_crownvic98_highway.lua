...
VEHICLE.Title 		= "1998 Ford Crown Victoria NYPD Highway Patrol"
		...
		Options = {
			{
				...
				SubMaterials = {
					{ Id = 3, Material = "rin/nypd/crownvic98/highway_98" }
				},
			},
		}
	},
				...
				Components = {
					{
						...
						Position = Vector( 0, -48, 71.8 ),
						Angles = Angle( 0, -90, 0 ),
						Scale = 0.92,
					},
					{
						Component = "photon_mars_flasher_nypd",
						Position = Vector( 21.4, -33, 74.3 ),
						Angles = Angle( 90, 0, 0 ),
						Scale = 1,
					},
					{
						Component = "photon_mars_flasher_nypd",
						Position = Vector( -21.4, -43, 74.3 ),
						Angles = Angle( -90, 0, 0 ),
						Scale = 1,
						Phase = 180,
					},
					...
					{
						Component = "photon_mars_flasher_nypd",
						Position = Vector( -20, -43, 70.1 ),
						Angles = Angle( 0, 0, 0 ),
						Scale = 1,
					},
					{
						Component = "photon_highrise_spotlight_nypd",
						Position = Vector( -8, -33, 77.8 ),
						Angles = Angle( 0, 0, 0 ),
						Scale = 1,
					},
					{
						Component = "photon_highrise_spotlight_nypd",
						Position = Vector( 8, -43, 77.8 ),
						Angles = Angle( 0, 0, 0 ),
						Scale = 1,
					},
				}
		...
		Options = {
			{
				...
				Props = {
					...
					},
					{
						...
						Position = Vector( 0, -54, 66.4 ),
						Angles = Angle( 0, 0, 7 ),
						Scale = 1
					},
					{
						Model = "models/schmal/antenna_vhf_2.mdl",
						Position = Vector( 0, -97, 47 ),
						Angles = Angle( 0, 0, 0 ),
