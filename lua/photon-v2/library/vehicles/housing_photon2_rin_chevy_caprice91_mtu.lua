...
VEHICLE.Title 		= "1991 Chevrolet Caprice Housing Police MTU"
...
VEHICLE.Equipment = {
	{
		...
		Options = {
			{
				Option = "Motor Transport Unit",
				SubMaterials = {
					{ Id = 20, Material = "rin/housing/caprice91/motor_91" },
					{ Id = 16, Material = "rin/nypd/caprice95/seats_blue" },
					{ Id = 24, Material = "rin/nypd/caprice95/dash_blue" }
				},
			},
			{
				Option = "Rescue Supervisor",
				SubMaterials = {
					{ Id = 20, Material = "rin/housing/caprice91/rescue_91" },
					{ Id = 16, Material = "rin/nypd/caprice95/seats_blue" },
					{ Id = 24, Material = "rin/nypd/caprice95/dash_blue" }
				},
			},
				...
				Components = {
					{
						...
						Position = Vector( 0, -33, 70 ),
						Angles = Angle( 0, 0, 0 ),
						Scale = 1,
					},
					{
						Component = "photon_highrise_spotlight_nypd",
						Position = Vector( 10, -33, 70 ),
						Angles = Angle( 0, 0, 0 ),
						Scale = 1,
					},
					{
					...
					{
						Component = "photon_highrise_spotlight_nypd",
						Position = Vector( 0, -43, 70 ),
						Angles = Angle( 0, 0, 0 ),
						Scale = 1,
					},
					{
						Component = "photon_highrise_spotlight_nypd",
						Position = Vector( 10, -43, 70 ),
						Angles = Angle( 0, 0, 0 ),
						Scale = 1,
					},
					{
